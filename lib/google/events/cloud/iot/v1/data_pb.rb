...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/events/cloud/iot/v1/data.proto", :syntax => :proto3) do
    add_message "google.events.cloud.iot.v1.Device" do
      optional :id, :string, 1
      optional :name, :string, 2
      optional :num_id, :uint64, 3
      repeated :credentials, :message, 12, "google.events.cloud.iot.v1.DeviceCredential"
      ...
      optional :config, :message, 13, "google.events.cloud.iot.v1.DeviceConfig"
      optional :state, :message, 16, "google.events.cloud.iot.v1.DeviceState"
      optional :log_level, :enum, 21, "google.events.cloud.iot.v1.LogLevel"
      map :metadata, :string, :string, 17
      optional :gateway_config, :message, 24, "google.events.cloud.iot.v1.GatewayConfig"
    end
    add_message "google.events.cloud.iot.v1.GatewayConfig" do
      optional :gateway_type, :enum, 1, "google.events.cloud.iot.v1.GatewayType"
...
module Google
  module Events
    module Cloud
      module Iot
        module V1
          Device = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.Device").msgclass
          GatewayConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.GatewayConfig").msgclass
          DeviceRegistry = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.DeviceRegistry").msgclass
          MqttConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.MqttConfig").msgclass
          HttpConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.HttpConfig").msgclass
          EventNotificationConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.EventNotificationConfig").msgclass
          StateNotificationConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.StateNotificationConfig").msgclass
          RegistryCredential = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.RegistryCredential").msgclass
          X509CertificateDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.X509CertificateDetails").msgclass
          PublicKeyCertificate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.PublicKeyCertificate").msgclass
          DeviceCredential = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.DeviceCredential").msgclass
          PublicKeyCredential = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.PublicKeyCredential").msgclass
          DeviceConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.DeviceConfig").msgclass
          DeviceState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.DeviceState").msgclass
          DeviceEventData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.DeviceEventData").msgclass
          RegistryEventData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.RegistryEventData").msgclass
          MqttState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.MqttState").enummodule
          HttpState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.HttpState").enummodule
          LogLevel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.LogLevel").enummodule
          GatewayType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.GatewayType").enummodule
          GatewayAuthMethod = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.GatewayAuthMethod").enummodule
          PublicKeyCertificateFormat = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.PublicKeyCertificateFormat").enummodule
          PublicKeyFormat = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.events.cloud.iot.v1.PublicKeyFormat").enummodule
        end
      end
    end
  end
